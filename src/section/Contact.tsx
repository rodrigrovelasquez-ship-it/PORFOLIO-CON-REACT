...
export default function Contact() {
  return (
    <section id="contacto" className="isolate mx-auto w-full max-w-6xl px-6 py-24 sm:py-32">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Contacto</h2>
        <p className="mt-2 text-lg/8 text-gray-400">Cuéntame tu idea y te respondo lo antes posible.</p>
      </div>
